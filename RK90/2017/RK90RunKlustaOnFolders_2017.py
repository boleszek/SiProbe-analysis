...
match_str = ['RK90_2016-07-29_raw_30k_1min_EMB','RK90_2016-09-11_raw_30k_30pres_EMB']
dfold_list = []
...
for dfold in dfold_list:
    ...
    dfold_temp = ddir+dfold+'/2017/'+shank1_fname
    ...
    dfold_temp = ddir+dfold+'/2017/'+shank2_fname
