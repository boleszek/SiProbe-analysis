...
match_str = ['RK90_2016-09-11_raw_30k_30pres_EMB','RK90_2016-07-29_raw_30k_1min_EMB']
dfold_list = []
...
for dfold in dfold_list:
    ...
    datname1 = dfold + '_' + shank1_fname
    OpenEphys.pack_2_BoMod(folderpath, filename = '2017/' + shank1_fname + '/' + datname1  + '.dat', source = '103',
                     channels = shnk1chan, dref=ref_choice)

    datname2 = dfold + '_' + shank2_fname
    OpenEphys.pack_2_BoMod(folderpath, filename = '2017/' + shank2_fname + '/' + datname2  + '.dat', source = '103',
    ...
    # for shank1                                                                        
    prmname1 = folderpath + '/2017/' + shank1_fname + '/' + dfold + '_' + shank1_fname + '.prm'
    replacements = {"'expfile'":"'"+datname1+"'",
    ...
    # for shank2                                                                        
    prmname2 = folderpath + '/2017/' + shank2_fname + '/' + dfold + '_' + shank2_fname + '.prm'
    replacements = {"'expfile'":"'"+datname2+"'",
