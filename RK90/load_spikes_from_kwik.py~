def load_spikes_from_kwik(dfile, clust_choice):
    '''
    This function finds extracts spike times and cluster labels from the kwik file. Since some
    clusters are unwanted (i.e. noise clusters), the function allows you to choose which clusters
    to load.
